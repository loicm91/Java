...
public class Menu {
    ...
    public void afficherMenu(Utilisateur user){
        ...
        System.out.println("Rechercher ami \t\t tapez R");
        System.out.println("Supprimer ami \t\t tapez J");
    ...
    public boolean ChoixMenu(Scanner sc, Utilisateur user) {
        ...
        switch (choix) {
            ...
            case "F":
                ...
                break;
            case "R":
                user.searchFriend(sc);
                break;
            case "J":
                user.deleteFriend(sc);            
                break;
            case "H":
    ...
    public char reStartAgain(Scanner sc){
        System.out.println("Voulez vous TOUT recommencer? (O/N)");
        return sc.nextLine().charAt(0);
    }
     //Menu employé
